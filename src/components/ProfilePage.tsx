    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${
        ...
        <div className={`text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
          ...
          <p className="text-gray-500">프로필을 관리하려면 먼저 로그인해주세요.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'} py-8`}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* 프로필 헤더 */}
        <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-lg overflow-hidden mb-8`}>
          {/* 배경 이미지 */}
          <div className="relative h-48 bg-gradient-to-r from-blue-500 to-purple-600">
            ...
            <button
              ...
              className="absolute top-4 right-4 p-2 bg-black bg-opacity-50 hover:bg-opacity-70 rounded-lg text-white transition-colors"
            >
            ...
            <div className="absolute -bottom-16 left-8">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute bottom-2 right-2 p-2 bg-blue-500 hover:bg-blue-600 rounded-full text-white shadow-lg transition-colors"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-lg p-6`}>
            ...
            <div className="space-y-3">
              ...
              {formData.sns && (
                <div className="flex items-center space-x-3">
                  <Link className={`h-5 w-5 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                  <a 
                    href={formData.sns}
                    target="_blank"
